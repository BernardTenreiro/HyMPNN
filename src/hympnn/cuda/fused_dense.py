"""CUDA-fused masked equivariant graph convolution.
...
def load_kernels(verbose=False):
    ...
    if _KERNELS is None:
        ...
        _KERNELS = load(
            name="hympnn_dense",
            sources=[os.path.join(here, "dense_convolution.cu")],
...
class FusedMaskedEquivariantGraphConvolution(nn.Module):
    """Fused masked equivariant convolution without coordinate updates."""
