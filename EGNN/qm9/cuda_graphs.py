...
def _read_capacity(name: str, default: int, minimum: int = 1) -> int:
...
class BucketedCudaGraphRunner:
    ...
    def __init__(
        ...
        self.dense_base = _read_capacity("EGNN_GRAPH_DENSE_CAP", 0, minimum=0)
        self.dense_quantum = _read_capacity("EGNN_GRAPH_DENSE_QUANTUM", 1024)
        self.sparse_quantum = _read_capacity("EGNN_GRAPH_SPARSE_QUANTUM", 128)
        self.sparse_small = _read_capacity("EGNN_GRAPH_SPARSE_SMALL_CAP", 768)
        self.sparse_large = _read_capacity("EGNN_GRAPH_SPARSE_LARGE_CAP", 1024)
        self.max_buckets = _read_capacity("EGNN_GRAPH_MAX_BUCKETS", 16)
